...
SELECT id, organization_id, account_id, role, status, created_at, updated_at, created_by, updated_by FROM organization_members
...
SELECT id, project_id, account_id, role, status, created_at, updated_at, created_by, updated_by FROM project_members
...
SELECT id, site_id, account_id, role, status, created_at, updated_at, created_by, updated_by FROM site_members
