...
func (c *OIDCClient) fetchDiscoveryDocument() error {
	// Format: {public_base_url}/v1/identity/oidc/provider/{provider}/.well-known/openid-configuration
	// This uses the public API URL since browsers need to access these endpoints via Traefik
